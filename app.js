...
document.addEventListener("keydown",e=>{if(e.key!=="Escape")return;if($("managerProfileModal")?.classList.contains("open"))closeManagerProfile();else if($("managerDirectoryModal")?.classList.contains("open"))closeManagerDirectory()});
