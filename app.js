/* IMO DYNASTY V3.3.65 — V3.3.63 Speed Baseline + Persistent Manager Profile Cache */
...
function managerProfilePersistentKey(key){return `imo-profile-v3365-persistent|${managerProfileDataFingerprint()}|${key}`}
