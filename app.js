...
function managerTradeLedgerInnerHTML(managerId,season){
  const ledger=managerNetTradeLedger(managerId,season),column=(title,rows,type)=>`<div class="manager-ledger-column ${type}"><div class="manager-ledger-column-head"><span>${esc(title)}</span><strong>${rows.length}</strong></div><div class="manager-ledger-assets">${rows.map(managerTradeLedgerAssetHTML).join('')||'<div class="manager-ledger-empty">No net trade movement</div>'}</div></div>`;
...
function ensureManagerGradeStyles(){
  ...
  .manager-trade-ledger-card{grid-column:1/-1}.manager-ledger-heading{align-items:flex-start}.manager-ledger-heading p{margin:4px 0 0;color:var(--muted,#94a3b8);font-size:11px}.manager-ledger-season{display:flex;align-items:center;gap:7px}.manager-ledger-season>span{font-size:10px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:var(--muted,#94a3b8)}.manager-ledger-season select{appearance:none;border:1px solid rgba(148,163,184,.22);border-radius:9px;background:rgba(15,23,42,.72);color:#fff;padding:7px 28px 7px 9px;font:800 11px/1.2 system-ui,sans-serif;cursor:pointer}.manager-ledger-columns{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.manager-ledger-column{min-width:0;border:1px solid rgba(148,163,184,.14);border-radius:12px;background:rgba(255,255,255,.025);overflow:hidden}.manager-ledger-column.in{border-top-color:rgba(74,222,128,.5)}.manager-ledger-column.out{border-top-color:rgba(248,113,113,.5)}.manager-ledger-column-head{display:flex;justify-content:space-between;align-items:center;padding:9px 10px;border-bottom:1px solid rgba(148,163,184,.12)}.manager-ledger-column-head span{font-size:10px;font-weight:900;letter-spacing:.09em}.manager-ledger-column.in .manager-ledger-column-head span{color:#86efac}.manager-ledger-column.out .manager-ledger-column-head span{color:#fca5a5}.manager-ledger-column-head strong{display:grid;place-items:center;min-width:22px;height:22px;border-radius:7px;background:rgba(148,163,184,.12);font-size:10px}.manager-ledger-assets{display:grid}.manager-ledger-asset{display:flex;align-items:center;gap:9px;min-width:0;padding:9px 10px;border-bottom:1px solid rgba(148,163,184,.09)}.manager-ledger-asset:last-child{border-bottom:0}.manager-ledger-avatar{position:relative;display:grid;place-items:center;width:30px;height:30px;border-radius:50%;overflow:hidden;background:rgba(148,163,184,.12);flex:0 0 auto}.manager-ledger-avatar img{width:100%;height:100%;object-fit:cover}.manager-ledger-avatar>span{display:none;place-items:center;width:100%;height:100%;font-size:9px;font-weight:900}.manager-ledger-copy{min-width:0;display:flex;flex-direction:column;gap:2px}.manager-ledger-copy .manager-ledger-player-link,.manager-ledger-copy strong{padding:0;border:0;background:none;color:#fff;font:800 11px/1.25 system-ui,sans-serif;text-align:left;white-space:normal}.manager-ledger-copy small{color:var(--muted,#94a3b8);font-size:9px}.manager-ledger-pick-icon{display:grid;place-items:center;width:30px;height:30px;border-radius:9px;background:rgba(143,115,255,.1);color:#a78bfa;font-size:12px;flex:0 0 auto}.manager-ledger-empty{padding:14px 10px;color:var(--muted,#94a3b8);font-size:10px}.manager-ledger-player-link{cursor:pointer}.manager-ledger-player-link:hover{text-decoration:underline}.manager-ledger-season select:focus-visible{outline:2px solid rgba(143,115,255,.75);outline-offset:2px}
